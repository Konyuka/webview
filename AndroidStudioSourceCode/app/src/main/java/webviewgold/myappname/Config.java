...
public class Config {
    ...
    public static final String PURCHASECODE = "963664be-3ca3-43c1-8a19-019e2ccb964c";
    // 4. Enjoy your app! :)
    ...
    public static final String USER_AGENT = "Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.196 Mobile Safari/537.36";
    ...
    //Set to "true" if you want to display AdSense ads
